...
<body>
     <div class="row justify-content-center align-items-center">
         ...
         <a href="modificarUsuario.php" class="btn btn-primary p-3 m-3">Modificar<br>Usuario</a>
         <a href="modificarMateria.php" class="btn btn-primary p-3 m-3">Modificar<br>Materia</a>
